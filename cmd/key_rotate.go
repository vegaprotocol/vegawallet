...
var (
	...
	rotateKeyExample = cli.Examples(`
		...
		vegawallet key rotate --wallet WALLET --tx-height TX_HEIGHT --target-height TARGET_HEIGHT --public-key PUBLIC_KEY
	`)
)
...
func (f *RotateKeyFlags) Validate() (*wallet.RotateKeyRequest, error) {
	...
	if req.TargetBlockHeight <= req.TxBlockHeight {
		return nil, flags.FlagRequireLessThanFlagError("target-height", "tx-height")
	}
